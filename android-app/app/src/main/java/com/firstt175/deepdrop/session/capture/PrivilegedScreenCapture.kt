...
internal class PrivilegedScreenCapture(
    ...
    /**
     * Captures directly into an Android HardwareBuffer.
     *
     * ZERO-COPY contract:
     *   ScreenCapture/SurfaceFlinger -> HardwareBuffer -> Binder handle ->
     *   NativeBridge -> AHardwareBuffer -> Vulkan external-memory image.
     *
     * Pixel data is never mapped into Java, copied to a Bitmap/ByteBuffer, or
     * copied through a CPU staging buffer.
     */
