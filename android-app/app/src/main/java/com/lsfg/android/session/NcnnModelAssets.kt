...
/**
 * Extracts the bundled `frame_interpolator_v2` ncnn model files (under assets/models) to
 * app-private internal storage. Native code (NcnnFG::initialize, see ncnn_framegen.cpp) needs real filesystem
