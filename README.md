...
This builds the APK, but frame generation itself needs a
...
repo (see the license notes in `android-app/README.md`).
The app prompts you to pick the DLL via the Storage Access Framework on
first launch.
